...
Original file is located at
    https://colab.research.google.com/drive/17TvQxBywF1icfGc-B1pPtmIFZQSMrgoR

# LSTM multiple classification of BBC articles

using [this dataset](https://djajafer.medium.com/multi-class-text-classification-with-keras-and-lstm-4c5525bef592)
